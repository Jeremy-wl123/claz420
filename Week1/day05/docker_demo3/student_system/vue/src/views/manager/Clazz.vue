  ...
  <div>
    ...
    <div class="card" style="margin-bottom: 5px">
      ...
      <el-table :data="data.tableData" stripe>
        <el-table-column label="班级编号" prop="no"></el-table-column>
    ...
    <el-dialog title="班级信息" width="40%" v-model="data.formVisible" :close-on-click-modal="false" destroy-on-close>
      <el-form ref="formRef" :model="data.form" :rules="data.rules" label-width="100px" style="padding-right: 50px">
        <el-form-item label="班级编号" prop="no">
          <el-input placeholder="请输入班级编号" v-model="data.form.no" autocomplete="off" />
        </el-form-item>
        ...
        <el-form-item label="班主任" prop="teacher">
          <el-input placeholder="请输入班主任" v-model="data.form.teacher" autocomplete="off" />
        </el-form-item>
      </el-form>
      <template #footer>

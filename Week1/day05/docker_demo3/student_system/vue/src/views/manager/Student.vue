<template>
  <div>
    ...
    <div class="card" style="margin-bottom: 5px;">
      <el-input v-model="data.name" style="width: 300px; margin-right: 10px" placeholder="请输入学生名称查询"></el-input>
      <el-input v-model="data.clazzName" style="width: 300px; margin-right: 10px" placeholder="请输入班级名称查询"></el-input>
      <el-input v-model="data.majorName" style="width: 300px; margin-right: 10px" placeholder="请输入专业名称查询"></el-input>
      ...
      <el-form ref="formRef" :model="data.form" :rules="data.rules" label-width="100px" style="padding-right: 50px">
        ...
        <el-form-item label="所属班级" prop="clazzId">
         ...
         <el-form-item label="学分" prop="score">
          <el-input-number :min="0" v-model="data.form.score" autocomplete="off" />
        </el-form-item>
      </el-form>
      <template #footer>

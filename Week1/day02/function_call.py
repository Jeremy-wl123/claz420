...
# 4. 模拟执行工具调用（这里假设模型请求调用 get_weather）
if assistant_msg.tool_calls:
    tool_call = assistant_msg.tool_calls[0]
    # 模拟工具返回的天气数据
    tool_result = {"role": "tool", "tool_call_id": tool_call.id, "content": get_weather(tool_call.function.arguments)}
    # tool_result = {"role": "tool", "tool_call_id": tool_call.id, "content": '28°C'}
